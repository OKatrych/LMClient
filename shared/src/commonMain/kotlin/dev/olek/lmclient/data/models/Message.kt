...
sealed interface Message {
    ...
    sealed interface MessageAttachment {
        @Serializable
        data class Image(val imageUri: String) : MessageAttachment

        @Serializable
        data class Video(val videoUri: String) : MessageAttachment

        @Serializable
        data class Audio(val audioUri: String) : MessageAttachment

        @Serializable
        data class File(val fileUri: String) : MessageAttachment
    }
